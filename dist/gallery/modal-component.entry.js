...
class ModalComponent {
    ...
    render() {
        ...
        })), h("button", { class: "btn__previous", style: { 'background-image': `url(${this.previousIconUrl})` }, onClick: this.previous.bind(this) }), h("button", { class: "btn__next", style: { 'background-image': `url(${this.nextIconUrl})` }, onClick: this.next.bind(this) })));
    }
    get modal() { return getElement(this); }
    static get style() { return ".modal {\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n.modal .header {\n  position: fixed;\n  top: 10px;\n  right: 10px;\n}\n.modal .header .header__btn {\n  position: relative;\n  width: 30px;\n  height: 30px;\n  margin-left: 10px;\n  padding: 0;\n  border: none;\n  background: transparent;\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n}\n.modal .modal__content {\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n  align-items: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  position: fixed;\n  top: 10%;\n  right: 10%;\n  bottom: 10%;\n  left: 10%;\n}\n.modal .modal__content img {\n  max-width: 100%;\n  max-height: 100%;\n  -webkit-transform: rotate(0deg);\n  transform: rotate(0deg);\n  -webkit-transition: -webkit-transform 0.3s ease-in-out;\n  transition: -webkit-transform 0.3s ease-in-out;\n  transition: transform 0.3s ease-in-out;\n  transition: transform 0.3s ease-in-out, -webkit-transform 0.3s ease-in-out;\n}\n.modal .btn__rotate, .modal .btn__previous, .modal .btn__next, .modal .btn__close {\n  background-color: transparent;\n  background-position: center center;\n  background-repeat: no-repeat;\n  background-size: contain;\n  cursor: pointer;\n}\n.modal .btn__previous, .modal .btn__next {\n  position: fixed;\n  top: 50%;\n  width: 50px;\n  height: 50px;\n  border: none;\n  border-radius: 50%;\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  -webkit-transform: translateY(-50%);\n  transform: translateY(-50%);\n}\n.modal .btn__previous {\n  left: 20px;\n}\n.modal .btn__next {\n  right: 20px;\n}"; }
}
