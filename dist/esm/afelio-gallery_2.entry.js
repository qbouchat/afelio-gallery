        ...
        if (this.galleryOptions.actions && this.galleryOptions.actions.length > 0) {
            return (h("div", { class: "afelio__gallery__actions__list-container" }, h("button", { class: "afelio__gallery__header__btn afelio__gallery__more__actions__btn", style: { 'background-image': `url('${this.galleryOptions.moreActionsIconUrl}')` }, onClick: this.showActionsList.bind(this) }), this.showActions &&
                h("ul", { class: "afelio__gallery__more__actions__list" }, this.galleryOptions.actions.map((action) => {
                    return (h("li", { class: "afelio__gallery__more__actions__item", onClick: () => this.customActionEmit(action) }, h("button", null, action.icon && h("span", { class: "afelio__gallery__header__btn btn__more-action-icon", style: { 'background-image': `url('${action.icon}')` } }), action.name)));
                }))));
        }
    }
    showActionsList() {
