import { r as registerInstance, h, c as createEvent, g as getElement } from './chunk-7bfd0333.js';
...
var ModalComponent = /** @class */ (function () {
    ...
    ModalComponent.prototype.generateActionsListButton = function () {
        return (h("div", { class: "afelio__gallery__actions__list-container" }, h("button", { class: "afelio__gallery__more__actions", onClick: this.showActionsList.bind(this) }), this.showActions &&
            h("ul", { class: "afelio__gallery__more__actions" }, this.actions.map(function (action) {
    ...
    ModalComponent.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "afelio__gallery__modal", onClick: function (event) { return _this.handleClickModal(event); } }, h("div", { class: "afelio__gallery__header" }, this.enableRotate && h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__rotate", style: { 'background-image': "url('" + this.rotateIconUrl + "')" }, onClick: this.rotate.bind(this) }), this.enableDelete && h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__delete", style: { 'background-image': "url('" + this.deleteIconUrl + "')" }, onClick: this.delete.bind(this) }), h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__close", style: { 'background-image': "url('" + this.closeIconUrl + "')" }, onClick: this.close.bind(this) }), this.actions.length > 0 && this.generateActionsListButton()), h("div", { class: "afelio__gallery__modal__content", ref: function (el) { return _this.modalContent = el; } }, this.images.map(function (img, index) {
