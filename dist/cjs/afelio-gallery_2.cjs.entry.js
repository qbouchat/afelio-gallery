...
class MyComponent {
    constructor(hostRef) {
        ...
        this.customActionFired = __chunk_1.createEvent(this, "customActionFired", 7);
    }
    changeImages() {
    ...
    showImage(indexImage) {
        ...
        this.modal.addEventListener('customActionFired', (e) => {
            this.customActionFired.emit(e.detail);
        });
...
class ModalComponent {
    ...
    generateActionsListButton() {
        if (this.galleryOptions.actions && this.galleryOptions.actions.length > 0) {
            return (__chunk_1.h("div", { class: "afelio__gallery__actions__list-container" }, __chunk_1.h("button", { class: "afelio__gallery__header__btn afelio__gallery__more__actions__btn", style: { 'background-image': `url('${this.galleryOptions.moreActionsIconUrl}')` }, onClick: this.showActionsList.bind(this) }), this.showActions &&
                __chunk_1.h("ul", { class: "afelio__gallery__more__actions__list" }, this.galleryOptions.actions.map((action) => {
                    return (__chunk_1.h("li", { class: "afelio__gallery__more__actions__item", onClick: () => this.customActionEmit(action) }, __chunk_1.h("button", null, action.icon && __chunk_1.h("span", { class: "afelio__gallery__header__btn btn__more-action-icon", style: { 'background-image': `url('${action.icon}')` } }), action.name)));
                }))));
        }
    }
    showActionsList() {
