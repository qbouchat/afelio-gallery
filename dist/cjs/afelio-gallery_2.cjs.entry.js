...
class ModalComponent {
    ...
    generateActionsListButton() {
        return (__chunk_1.h("div", { class: "afelio__gallery__actions__list-container" }, __chunk_1.h("button", { class: "afelio__gallery__more__actions", onClick: this.showActionsList.bind(this) }), this.showActions &&
            __chunk_1.h("ul", { class: "afelio__gallery__more__actions" }, this.actions.map((action) => {
    ...
    render() {
        return (__chunk_1.h("div", { class: "afelio__gallery__modal", onClick: (event) => this.handleClickModal(event) }, __chunk_1.h("div", { class: "afelio__gallery__header" }, this.enableRotate && __chunk_1.h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__rotate", style: { 'background-image': `url('${this.rotateIconUrl}')` }, onClick: this.rotate.bind(this) }), this.enableDelete && __chunk_1.h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__delete", style: { 'background-image': `url('${this.deleteIconUrl}')` }, onClick: this.delete.bind(this) }), __chunk_1.h("button", { class: "afelio__gallery__header__btn afelio__gallery__btn__close", style: { 'background-image': `url('${this.closeIconUrl}')` }, onClick: this.close.bind(this) }), this.actions.length > 0 && this.generateActionsListButton()), __chunk_1.h("div", { class: "afelio__gallery__modal__content", ref: (el) => this.modalContent = el }, this.images.map((img, index) => {
